...
export default function AdoptHero() {
  return (
    <section className="relative overflow-hidden bg-pink-600 py-16 sm:py-24">
      <div className="absolute inset-0 -z-10 h-full w-full bg-pink-600 bg-[linear-gradient(to_right,#3b82f6_1px,transparent_1px),linear-gradient(to_bottom,#3b82f6_1px,transparent_1px)] bg-[size:4rem_4rem] opacity-30"></div>
