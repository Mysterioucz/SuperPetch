    ...
    <div className="rounded-2xl bg-white shadow-sm ring-1 ring-slate-900/5">
      ...
      <div className="p-6">
        <div className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <Link
            href="/adopt"
            className="mt-6 rounded-full bg-blue-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
          >
            Browse Pets
          </Link>
        </div>
