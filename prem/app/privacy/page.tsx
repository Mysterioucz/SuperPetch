                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 space-y-8">
                    <section>
                        ...
                        <p className="text-gray-700 leading-relaxed">
                            Welcome to PetPlatform. We respect your privacy and are committed to protecting your personal data.
                    ...
                    <section>
                        ...
                        <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                            ...
                            <li><strong>Pet Data:</strong> Information about pets you list or adopt</li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                            <p className="text-gray-700">
                                <strong>Email:</strong> privacy@petplatform.com<br />
